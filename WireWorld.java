...
public class WireWorld {
    ...
    private static String inputFileName = "..\\WireWorld\\src\\main\\java\\WireWorld\\in_out_files\\defaultInput.txt";
        ...
        WindowListener listener = new WindowAdapter() {
            public void windowClosed(WindowEvent evt) {
                ...
                try {
                    ...
                    try {
                        cellSet.saveCellSetToFile("..\\WireWorld\\src\\main\\java\\WireWorld\\in_out_files\\output.txt");
                    } catch (IOException e) {
